...
function Swatch({ name, cssVar, description, textOnTop }: SwatchProps) {
  ...
  return (
    ...
    >
      ...
      {description && (
        <span style={{ fontSize: '10px', color: 'var(--pluto-color-text-tertiary)' }}>
          {description}
        </span>
      )}
    </div>
  ...
  return (
    <div
      style={{
        ...
        background: 'var(--pluto-color-background-default)',
        minHeight: '100vh',
      }}
    >
      <h1
        style={{
          ...
          fontWeight: 700,
          marginBottom: '8px',
          color: 'var(--pluto-color-text-heading)',
        }}
      >
        Color Primitives
      </h1>
      ...
      >
        Raw color palette — Warm Cream + Golden Yellow system. Never reference these in components —
      ...
      {palettes.map(({ label, category, steps }) => (
        <div key={category} style={{ marginBottom: '32px' }}>
          ...
          <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
            {steps.map((step) => (
              <Swatch key={step} name={step} cssVar={`--pluto-color-${category}-${step}`} />
            ))}
          </div>
        </div>
      ))}
        ...
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          {['0', '4', '8', '12', '16', '24', '32', '48', '64', '80'].map((step) => (
            <Swatch
              key={step}
              name={`black/${step}`}
              cssVar={`--pluto-color-alpha-black-${step}`}
            />
          ))}
        </div>
      </div>
        ...
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          {['4', '8', '12', '16', '24', '32', '48', '64', '80'].map((step) => (
            <Swatch
              key={step}
              name={`white/${step}`}
              cssVar={`--pluto-color-alpha-white-${step}`}
            />
          ))}
        </div>
      </div>
...
function SemanticColors() {
  const groups: GroupProps[] = [
      ...
      tokens: [
        {
          ...
          var: '--pluto-color-background-default',
          desc: 'Page canvas',
        },
        {
          name: 'background/subtle',
          var: '--pluto-color-background-subtle',
          desc: 'Secondary surfaces',
        },
        {
          name: 'background/muted',
          var: '--pluto-color-background-muted',
          desc: 'Tertiary, sidebar',
        },
        {
          name: 'background/emphasis',
          var: '--pluto-color-background-emphasis',
          desc: 'Inverted — dark nav',
        },
        {
          name: 'background/disabled',
          var: '--pluto-color-background-disabled',
          desc: 'Disabled surface',
        },
        {
          name: 'background/inverse',
          var: '--pluto-color-background-inverse',
          desc: 'Opposite theme bg',
        },
        {
          name: 'background/on-primary',
          var: '--pluto-color-background-on-primary',
          desc: 'Golden tint bg',
        },
        {
          name: 'background/on-success',
          var: '--pluto-color-background-on-success',
          desc: 'Success tint bg',
        },
        {
          name: 'background/on-warning',
          var: '--pluto-color-background-on-warning',
          desc: 'Warning tint bg',
        },
        {
          name: 'background/on-danger',
          var: '--pluto-color-background-on-danger',
          desc: 'Danger tint bg',
        },
        {
          name: 'background/on-info',
          var: '--pluto-color-background-on-info',
          desc: 'Info tint bg',
        },
      ],
    },
    {
      ...
      tokens: [
        ...
        { name: 'surface/sunken', var: '--pluto-color-surface-sunken', desc: 'Code blocks, inset' },
        {
          ...
          var: '--pluto-color-surface-interactive',
          desc: 'Hover rows',
        },
        ...
        { name: 'surface/secondary', var: '--pluto-color-surface-secondary', desc: 'Slate-tinted' },
        {
          ...
          var: '--pluto-color-surface-inverse',
          desc: 'Dark surface in light',
        },
      ],
    },
    {
      ...
      tokens: [
        ...
        { name: 'text/link-hover', var: '--pluto-color-text-link-hover', desc: 'Link hover' },
        {
          ...
          var: '--pluto-color-text-on-emphasis',
          desc: 'On dark bg — 21:1',
        },
        {
          name: 'text/on-primary',
          var: '--pluto-color-text-on-primary',
          desc: '⚠ Dark on golden 6:1',
        },
        {
          name: 'text/placeholder',
          var: '--pluto-color-text-placeholder',
    ...
    },
    {
      ...
      tokens: [
        ...
        { name: 'border/disabled', var: '--pluto-color-border-disabled', desc: 'Disabled' },
        {
          ...
          var: '--pluto-color-border-interactive',
          desc: 'Input default',
        },
        {
          name: 'border/interactive-hover',
          var: '--pluto-color-border-interactive-hover',
          desc: 'Input hover',
        },
        ...
        {
          name: 'border/on-emphasis',
          var: '--pluto-color-border-on-emphasis',
          desc: 'On dark surfaces',
        },
    ...
    },
    {
      ...
      tokens: [
        ...
        { name: 'action/primary/hover', var: '--pluto-color-action-primary-hover', desc: 'Hover' },
        {
          ...
          var: '--pluto-color-action-primary-active',
          desc: 'Pressed',
        },
        {
          name: 'action/primary/disabled',
          var: '--pluto-color-action-primary-disabled',
          desc: 'Disabled fill',
        },
        {
          name: 'action/primary/text',
          var: '--pluto-color-action-primary-text',
          desc: '⚠ Dark on golden 6:1',
        },
        {
          name: 'action/primary/subtle',
          var: '--pluto-color-action-primary-subtle',
          desc: 'Ghost bg',
        },
        {
          name: 'action/primary/subtle-hover',
          var: '--pluto-color-action-primary-subtle-hover',
          desc: 'Ghost hover',
        },
      ],
    },
    {
      ...
      tokens: [
        ...
        { name: 'action/secondary/disabled', var: '--pluto-color-action-secondary-disabled' },
        {
          ...
          var: '--pluto-color-action-secondary-text',
          desc: 'On secondary',
        },
        { name: 'action/secondary/subtle', var: '--pluto-color-action-secondary-subtle' },
        {
          name: 'action/secondary/subtle-hover',
          var: '--pluto-color-action-secondary-subtle-hover',
        },
      ],
    },
    {
      ...
      tokens: [
        {
          name: 'action/ghost/default',
          var: '--pluto-color-action-ghost-default',
          desc: 'Transparent',
        },
        {
          name: 'action/ghost/hover',
          var: '--pluto-color-action-ghost-hover',
          desc: 'Subtle fill',
        },
    ...
    },
    {
      ...
      tokens: [
        ...
        {
          name: 'action/destructive/text',
          var: '--pluto-color-action-destructive-text',
          desc: 'On danger fill',
        },
        { name: 'action/destructive/subtle', var: '--pluto-color-action-destructive-subtle' },
        {
          name: 'action/destructive/subtle-hover',
          var: '--pluto-color-action-destructive-subtle-hover',
        },
      ],
    },
    {
      ...
      tokens: [
        {
          ...
          var: '--pluto-color-status-success-bg',
          desc: 'Light tint bg',
        },
        {
          name: 'status/success/bg-strong',
          var: '--pluto-color-status-success-bg-strong',
          desc: 'Bold fill',
        },
        {
          name: 'status/success/text',
          var: '--pluto-color-status-success-text',
          desc: '4.5:1 on bg',
        },
        {
          name: 'status/success/text-strong',
          var: '--pluto-color-status-success-text-strong',
          desc: 'On bold fill',
        },
  ...
  return (
    ...
    >
      ...
      >
        116 intent-based tokens across 8 groups. Switch themes in the toolbar — every token adapts
        automatically. Components should <strong>only</strong> consume these.
      </p>
      <div
        style={{
          display: 'inline-flex',
          ...
          marginBottom: '40px',
          padding: '8px 12px',
          background: 'var(--pluto-color-background-on-primary)',
          borderRadius: '6px',
          border: '1px solid var(--pluto-color-border-primary)',
        }}
      >
        <span style={{ fontSize: '12px', color: 'var(--pluto-color-text-default)' }}>
          ⚠ <strong>text/on-primary</strong> + <strong>action/primary/text</strong> use dark text on
          golden — WCAG AA override (white fails 1.4:1)
        </span>
      </div>
...
export const Primitives: StoryObj = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Raw color scales — Warm Cream neutrals, Golden Yellow primary, Warm Slate secondary, Emerald success, Orange warning, Coral Rose danger, Sky Blue info. Never use these in components directly.',
      },
    },
  },
};
...
export const Semantic: StoryObj = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'All 116 semantic tokens in one view: background (11), surface (9), text (17), icon (10), border (15), overlay (2), action (28), status (24). Switch themes in the toolbar to see live adaptation.',
      },
    },
  },
};
